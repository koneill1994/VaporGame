...
public class MenuController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.Log(i);
            Dropdown.OptionData list = new Dropdown.OptionData(SceneManager.GetSceneAt(i).name);
    ...
    {
        SceneManager.LoadScene(dropdown.value); //this will load our first level from our build settings. "1" is the second scene in our game
